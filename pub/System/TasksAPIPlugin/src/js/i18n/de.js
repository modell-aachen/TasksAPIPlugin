if ( jsi18n && typeof jsi18n.add === 'function') {
  jsi18n.add('tasksapi', {
    ...
    "Attachment filename exceeds length limit. Please shorten the filename, e.g.: ": "Dateiname überschreitet die zulässige Länge. Bitte verwenden Sie einen kürzeren Namen, z.B.: ",
